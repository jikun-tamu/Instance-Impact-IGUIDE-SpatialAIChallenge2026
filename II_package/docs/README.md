...
- `scripts/driver/run_instance_impact_driver.py` (orchestrates Stage1 -> Stage2 -> presentation)
- `scripts/stage3/present_instance_results.py` (merges Stage1/2a/2b outputs and prints terminal summaries)
...
5. Presentation merge (`scripts/stage3/present_instance_results.py`)
6. Instance-level overlays (`scripts/stage3/visualize_stage2_overlays.py`)
